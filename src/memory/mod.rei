...
fn ttbr1() -> u64 { TTBR1.get() }
fn ttbr0() -> u64 { TTBR0.get() }

fn set_ttbr0(val: u64) { TTBR0.set(val) }
fn set_ttbr1(val: u64) { TTBR1.set(val) }
...
*#
fn walk_table_4k(table_addr: u64, descriptor_type: DescriptorType) {
